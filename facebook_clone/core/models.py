...
class Comment(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)#in User has Profile
...
class ReplyComment(models.Model):
    ...
    comment = models.ForeignKey(Comment, on_delete=models.CASCADE)#take Comment as foreign key
...
#create class for notifications
class Notification(models.Model):
    #foreign key is linked w current User
    ...
    date = models.DateTimeField(auto_now_add=True)
    nid = ShortUUIDField(length=7, max_length=25, alphabet="abcdefghijklmnopqrstuvxyz123")
