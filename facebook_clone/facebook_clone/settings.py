...
SECRET_KEY = 'django-insecure-mv418ieiw%d9yd53w#9=7t93r5rg40a$w=mev0-awxrp_beg1k'
...
CHANNEL_LAYERS = { # channel layer is used for real data chat, and allowed different web applications
    'default': {
